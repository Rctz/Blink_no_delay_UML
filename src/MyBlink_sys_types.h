...
#ifndef MYBLINK_SYS_TYPES_H
#define MYBLINK_SYS_TYPES_H
#ifdef	__cplusplus
extern	"C"	{
#endif
...
#define Blink_DOMAIN_ID 0
#define Blink_DOMAIN_ID_text "Blink"
